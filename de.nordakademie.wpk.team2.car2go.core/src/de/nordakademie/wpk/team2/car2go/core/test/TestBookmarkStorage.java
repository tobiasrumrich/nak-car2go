...
/**
 * This JUnit test checks for appropriate behavior of the IBookmarkStorage
...
public class TestBookmarkStorage {
	...
	@Test
	public void testAddBookmark() throws DuplicateBookmarkException,
			IllegalUsernameException, IllegalRegistrationNumberException {
	...
	public void testAddBookmarkDuplicate() throws DuplicateBookmarkException,
			IllegalUsernameException, IllegalRegistrationNumberException {
		bs.addBookmark("Tester3", testCar1);
		bs.addBookmark("Tester3", testCar1);
	}
	...
	public void testAddBookmarkEmptyUsername()
	...
	@Test(expected = IllegalUsernameException.class)
	public void testAddBookmarkNullUsername()
			throws DuplicateBookmarkException, IllegalUsernameException,
			IllegalRegistrationNumberException {
	...
	public void testAddBookmarkNullCar() throws DuplicateBookmarkException,
			IllegalUsernameException, IllegalRegistrationNumberException {
		bs.addBookmark("Tester3", null);
	}

	@Test(expected = IllegalRegistrationNumberException.class)
	public void testAddBookmarkNullRegistrationNumber()
			throws DuplicateBookmarkException, IllegalUsernameException,
			IllegalRegistrationNumberException {
		Car c = new Car();
	...
	@Test(expected = IllegalRegistrationNumberException.class)
	public void testAddBookmarkEmptyRegistrationNumber()
			throws DuplicateBookmarkException, IllegalUsernameException,
			IllegalRegistrationNumberException {
		Car c = new Car();
	...
	@Test
	public void testRemoveBookmark() throws IllegalUsernameException,
	...
	@Test(expected = IllegalUsernameException.class)
	public void testRemoveBookmarkUsernameNull()
	...
	@Test(expected = IllegalUsernameException.class)
	public void testRemoveBookmarkUsernameEmpty()
			throws IllegalUsernameException,
			RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, UsernameNotFoundException {
	...
	public void testRemoveBookmarkWrongUsername()
			throws IllegalUsernameException,
			RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, UsernameNotFoundException {
	...
	@Test(expected = IllegalRegistrationNumberException.class)
	public void testRemoveBookmarkRegistrationNumberNull()
			throws IllegalUsernameException,
			RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, UsernameNotFoundException {
	...
	@Test(expected = IllegalRegistrationNumberException.class)
	public void testRemoveBookmarkRegistrationNumberEmpty()
			throws IllegalUsernameException,
			RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, UsernameNotFoundException {
	...
	public void testRemoveBookmarkWrongRegistrationNumber()
			throws IllegalUsernameException,
			RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, UsernameNotFoundException {
