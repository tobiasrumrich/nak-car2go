...
/**
 * This tests checks for appropriate behavior of the ICarService implementation
 * 
 * @author dep18237
 * 
 */
public class TestCarService {
	...
	@Test
	public void testSetComment() throws RegistrationNumberNotFoundException,
	...
	public void testSetCommentNullRegistrationNumber()
	...
	public void testSetCommentEmptyRegistrationNumber()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, IllegalCommentException {
	...
	public void testSetCommentWrongRegistrationNumber()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, IllegalCommentException {
	...
	@Test(expected = RegistrationNumberNotFoundException.class)
	public void testGetMapWrongRegistrationNumber()
			throws RegistrationNumberNotFoundException,
	...
	@Test(expected = IllegalRegistrationNumberException.class)
	public void testGetMapNullRegistrationNumber()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, MapRetrievalException {
	...
	@Test(expected = IllegalRegistrationNumberException.class)
	public void testGetMapEmptyRegistrationNumber()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, MapRetrievalException {
	...
	public void testGetMapWrongWidth()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, IllegalCommentException,
			MapRetrievalException {
		cs.getMapForCar("ZZ-ZZ-ZZZZ", 1, 100, 10);
	}

	@Test(expected = MapRetrievalException.class)
	public void testGetMapWrongHeight()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, IllegalCommentException,
			MapRetrievalException {
	...
	@Test(expected = MapRetrievalException.class)
	public void testGetMapWrongZoom()
			throws RegistrationNumberNotFoundException,
			IllegalRegistrationNumberException, IllegalCommentException,
			MapRetrievalException {
